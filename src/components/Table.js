...
function Table(props) {
  ...
  const url = `http://localhost:8080/1805142/TABLE?page=${pageCount}&limit=10%60`;
        ...
        <TableBody>
          {responseData.map((response, i) => (
            ...
            >
              ...
              <TableCell class="font">{response.bill_id} </TableCell>
              ...
              <TableCell class="font due">{response.due_in_date}</TableCell>
